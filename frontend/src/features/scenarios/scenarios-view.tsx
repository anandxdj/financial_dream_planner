...
export function ScenariosList() {
  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      {/* ========================================================================= */}
      {/* 05 EXPLORE SCENARIOS (Board 08 Panel 05) */}
      {/* ========================================================================= */}
      <section aria-labelledby="explore-scenarios-heading" className="space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <span className="text-xs font-bold tracking-wider uppercase text-[#5E55C9]">
              05 Explore Scenarios
            </span>
            <h1
              id="explore-scenarios-heading"
              className="text-3xl md:text-4xl lg:text-5xl font-serif text-[#1F2A44] leading-tight"
            >
              Compare life possibilities
            </h1>
            <p className="mt-2 text-base md:text-lg text-[#475467]">
              See how different choices can change your future.
            </p>
          </div>
          <div className="hidden sm:block text-right">
            <span className="font-serif italic text-[#5E55C9] text-base block">
        ...
        <div className="grid gap-6 md:grid-cols-3 items-stretch">
          ...
          <div className="rounded-2xl border-2 border-[#5E55C9]/40 bg-[#FFFCF8] p-6 shadow-xs flex flex-col justify-between">
            <div className="space-y-4">
              <div className="size-12 rounded-full bg-[#EDE9FE] text-[#5E55C9] flex items-center justify-center">
                <BarChart3 className="size-6" />
              </div>
              <div>
                <h2 className="font-serif font-semibold text-xl text-[#1F2A44]">
                  Base Case
                </h2>
                <p className="mt-1 text-xs text-[#475467] leading-relaxed">
                  A balanced plan based on your current inputs.
                </p>
              </div>
              <div className="pt-2">
                <span className="text-xs text-[#475467] block">Projected net worth at 2055</span>
                <p className="text-3xl font-serif font-bold text-[#1F2A44] tabular-nums mt-0.5">
                  ₹ 2.4 Cr
                </p>
              </div>
            </div>
            <div className="mt-6 pt-4 border-t border-[#E8E1D6]/70">
              <button
                type="button"
          ...
          <div className="rounded-2xl border border-[#E8E1D6] bg-[#FFFCF8] p-6 shadow-xs flex flex-col justify-between">
            <div className="space-y-4">
              <div className="size-12 rounded-full bg-[#DCFCE7] text-[#16A34A] flex items-center justify-center">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-[#475467] leading-relaxed">
                  Retire at 55 and maintain your lifestyle.
                </p>
              </div>
              <div className="pt-2">
                <span className="text-xs text-[#475467] block">Projected net worth at 2055</span>
          ...
          {/* Scenario 3: Higher Education */}
          <div className="rounded-2xl border border-[#E8E1D6] bg-[#FFFCF8] p-6 shadow-xs flex flex-col justify-between">
            <div className="space-y-4">
              <div className="size-12 rounded-full bg-[#DBEAFE] text-[#2563EB] flex items-center justify-center">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-[#475467] leading-relaxed">
                  Plan for your child's education in 2035.
                </p>
              </div>
              <div className="pt-2">
                <span className="text-xs text-[#475467] block">Projected net worth at 2055</span>
      ...
      {/* ========================================================================= */}
      {/* 06 SCENARIO COMPARISON (Board 08 Panel 06) */}
      {/* ========================================================================= */}
      <section aria-labelledby="scenario-matrix-heading" className="space-y-6">
        <div>
          <span className="text-xs font-bold tracking-wider uppercase text-[#5E55C9]">
            06 Scenario Comparison
          </span>
          <h2
            id="scenario-matrix-heading"
          ...
          <p className="mt-1 text-sm md:text-base text-[#475467]">
            Compare key outcomes across scenarios.
          </p>
        </div>

        <div className="rounded-2xl border border-[#E8E1D6] bg-[#FFFCF8] p-5 sm:p-6 shadow-xs overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              <caption className="sr-only">Key outcome matrix across scenarios at 2055</caption>
              <thead>
                <tr className="border-b border-[#E8E1D6]">
                  <th scope="col" className="p-3.5 text-xs font-bold uppercase tracking-wider text-[#475467]">
                    Outcome (at 2055)
                  </th>
                  <th scope="col" className="p-3.5 bg-[#EFF6FF] text-[#1E40AF] font-serif font-semibold text-base rounded-t-lg">
                    Base Case
                  </th>
                  <th scope="col" className="p-3.5 bg-[#F0FDF4] text-[#166534] font-serif font-semibold text-base rounded-t-lg">
                    Early Retirement
                  </th>
                  <th scope="col" className="p-3.5 bg-[#FAF5FF] text-[#6B21A8] font-serif font-semibold text-base rounded-t-lg">
                    Higher Education
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#E8E1D6]/70">
                <tr>
                  <th scope="row" className="p-3.5 font-medium text-[#475467]">
                    Retirement age
                  </th>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">60</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">55</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">60</td>
                </tr>
                <tr>
                  <th scope="row" className="p-3.5 font-medium text-[#475467]">
                  ...
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 2.4 Cr</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 2.1 Cr</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 2.3 Cr</td>
                </tr>
                <tr>
                  <th scope="row" className="p-3.5 font-medium text-[#475467]">
                    Monthly income (today's value)
                  </th>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 1.2 L</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 1.4 L</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 1.2 L</td>
                </tr>
                <tr>
                  <th scope="row" className="p-3.5 font-medium text-[#475467]">
                  ...
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 1.1 Cr</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 1.4 Cr</td>
                  <td className="p-3.5 font-semibold text-[#1F2A44] tabular-nums">₹ 1.3 Cr</td>
                </tr>
                <tr>
                  <th scope="row" className="p-3.5 font-medium text-[#475467]">
                    Probability of success
                  </th>
                  <td className="p-3.5 font-semibold text-[#3D5C4A] tabular-nums">82%</td>
                  <td className="p-3.5 font-semibold text-[#7D5200] tabular-nums">68%</td>
                  <td className="p-3.5 font-semibold text-[#3D5C4A] tabular-nums">76%</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      {/* ========================================================================= */}
      {/* SAVED HOUSEHOLD DECISION SCENARIOS */}
      {/* ========================================================================= */}
      <section aria-labelledby="decision-scenarios-heading" className="space-y-6 pt-4">
        <PageTitle
        ...
        <div className="rounded-2xl border border-border bg-[#FFFCF8] p-5 shadow-xs">
        ...
        {scenarios.length > 1 && (
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border bg-[#FFF9F0]/60 p-4">
        ...
        {/* Dynamic Side-by-Side Scenario Comparison Section */}
        {comparing && compareQuery.data && (
          <section
            aria-label="Side-by-side scenario comparison"
            className="rounded-2xl border-2 border-[#5E55C9] bg-[#FFFCF8] p-5 sm:p-6 shadow-sm"
          >
...
export function ScenarioCreate() {
  ...
  return (
    <div className="space-y-8 max-w-4xl pb-16">
      {/* ========================================================================= */}
      {/* 08 CREATE NEW SCENARIO (Board 08 Panel 08) */}
      {/* ========================================================================= */}
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <span className="text-xs font-bold tracking-wider uppercase text-[#5E55C9]">
            08 Create New Scenario
          </span>
          <h1 className="text-3xl md:text-4xl font-serif text-[#1F2A44] leading-tight">
            Build your own scenario
          </h1>
          <p className="mt-1 text-sm md:text-base text-[#475467]">
            Adjust your goals and see the impact instantly.
          </p>
        </div>
        <div className="hidden sm:block text-right">
          <span className="font-serif italic text-[#5E55C9] text-sm block">
            Small changes today can open new possibilities.
          </span>
          <Link className={`${secondary} mt-2 text-xs`} href="/dashboard/scenarios">
            Cancel
          </Link>
        </div>
      </div>
        ...
        <Panel title="Scenario metadata">
          <div className="space-y-4">
            <Field
              ...
              required
              maxLength={100}
              placeholder="e.g. Sabbatical Year, Job Change (+20%)"
            />

            <div className="space-y-1.5">
              <label htmlFor="scenario-preset" className="block font-semibold text-sm text-[#1F2A44]">
                What would you like to change?
              </label>
              <select
                id="scenario-preset"
                className={control}
                defaultValue="Take a 1-year career break in 2030"
              >
                <option value="Take a 1-year career break in 2030">
                  Take a 1-year career break in 2030
                </option>
                <option value="Salary raise or new job offer">
                  Salary raise or new job offer
                </option>
                <option value="Buy a car or home with loan">
                  Buy a car or home with loan
                </option>
                <option value="Early retirement at 55">
                  Early retirement at 55
                </option>
                <option value="Child higher education fund">
                  Child higher education fund
                </option>
                <option value="Custom financial adjustment">
                  Custom financial adjustment
                </option>
              </select>
            </div>

            <div className="space-y-1.5">
              <label htmlFor="description" className="block font-semibold text-sm text-[#1F2A44]">
